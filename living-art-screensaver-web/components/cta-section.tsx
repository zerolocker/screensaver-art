  ...
  return (
    <section id="get" className="relative px-[30px] pt-[120px] pb-[124px] text-center">
      <div className="relative z-2 mx-auto max-w-[760px]">
        ...
        <p className="m-0 mb-[30px] text-[19px] leading-normal text-muted-foreground-strong">
        ...
        <PlatformInterest
          location="cta"
          className="mt-[10px] inline-block cursor-pointer text-[13px] text-muted-foreground underline decoration-primary/50 underline-offset-4 transition-colors hover:decoration-primary"
        />
