...
through their bio links, once those carry tags; TikTok through a plain-text pinned comment, so
untagged), so the next thing this hub gains is
...
- **TikTok's pinned comment** — every video since 2026-09-14 should open its comments on *Get
  the screensaver app: living-art-screensaver.com*, pinned, when viewed signed out. A miss shows
  in the run log as `⚠ tiktok link comment` and on the ledger entry as `linkComment`.
...
- **2026-09-14** — **TikTok gets its link as a pinned comment.** TikTok was the one channel whose
  ...
  business licence), and a personal account gets no bio link until 1,000 followers. Zernio moved
  TikTok onto the **TikTok Business app** on 2026-09-10, which added comment posting and pinning
  with no Business account needed; the founder reconnected to switch lanes.
  `post-social.mjs` now comments *Get the screensaver app: living-art-screensaver.com* under each
  TikTok video and pins it. **Live-tested first:** the comment posted, pinned on the second try
...
- **2026-09-12** — **Social clips: zoomed art, its title underneath, one fixed caption.** Founder
  ...
  lead with one fixed caption, *Animated art screensaver app - Link in bio***: short enough
